// venues/halfwayHotel.js

export default {
  VENUE_ID: "Halfway Hotel",
  SOURCE: "HalfwayHotelWeb",
  START_URL: "https://www.halfwaybar.au/",

  async listPage($, request) {
    const events = [];

    $("a[href*='event'], a[href*='whats-on'], a[href*='whatson'], a[href*='tickets']").each((_, el) => {
